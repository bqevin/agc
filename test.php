...
<head>
	...
	<title>Africa Gender Centre</title>
	...
	<link rel="apple-touch-icon" sizes="57x57" href="blogpost/favicons/apple-touch-icon-57x57.png">
	<link rel="apple-touch-icon" sizes="60x60" href="blogpost/favicons/apple-touch-icon-60x60.png">
	<link rel="apple-touch-icon" sizes="72x72" href="blogpost/favicons/apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="76x76" href="blogpost/favicons/apple-touch-icon-76x76.png">
	<link rel="apple-touch-icon" sizes="114x114" href="blogpost/favicons/apple-touch-icon-114x114.png">
	<link rel="apple-touch-icon" sizes="120x120" href="blogpost/favicons/apple-touch-icon-120x120.png">
	<link rel="apple-touch-icon" sizes="144x144" href="blogpost/favicons/apple-touch-icon-144x144.png">
	<link rel="apple-touch-icon" sizes="152x152" href="blogpost/favicons/apple-touch-icon-152x152.png">
	<link rel="apple-touch-icon" sizes="180x180" href="blogpost/favicons/apple-touch-icon-180x180.png">
	<link rel="icon" type="image/png" href="blogpost/favicons/favicon-32x32.png" sizes="32x32">
	<link rel="icon" type="image/png" href="blogpost/favicons/favicon-194x194.png" sizes="194x194">
	<link rel="icon" type="image/png" href="blogpost/favicons/favicon-96x96.png" sizes="96x96">
	<link rel="icon" type="image/png" href="blogpost/favicons/android-chrome-192x192.png" sizes="192x192">
	<link rel="icon" type="image/png" href="blogpost/favicons/favicon-16x16.png" sizes="16x16">
	<link rel="manifest" href="blogpost/favicons/manifest.json">
	<link rel="shortcut icon" href="blogpost/favicons/favicon.ico">
	<meta name="msapplication-TileColor" content="#603cba">
	<meta name="msapplication-TileImage" content="blogpost/favicons/mstile-144x144.png">
	<meta name="msapplication-config" content="blogpost/favicons/browserconfig.xml">
	<meta name="theme-color" content="#ffffff">
	<link rel="stylesheet" href="blogpost/css/bootstrap.css">
	<link rel="stylesheet" href="blogpost/fonts/font-awesome-4.3.0/css/font-awesome.min.css">
	<link rel="stylesheet" href="blogpost/css/all.css">
...
<div id="wrapper">
		<header id="header">
			<div class="container">
				<div class="logo"><a href="#"><img src="blogpost/images/logo.svg" alt="FORKIO"></a></div>
				<nav id="nav">
	...
	<section class="visual">
		...
		<img src="blogpost/images/img-decor-01.jpg" alt="" class="bg-stretch">
	</section>
	<section class="main">
		<div class="container">
			<div id="cta">
			...
			<div class="row">
				<div class="text-box col-md-offset-1 col-md-10">
					...
					<div class="social-placeholder"><img src="blogpost/images/img-social-placeholder-01.png" height="26" width="365" alt=""></div>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
					...
					<ul class="visual-list">
						<li>
							<div class="img-holder">
								<img src="blogpost/images/graph-04.svg" width="110" alt="">
							</div>
						...
						<li>
							<div class="img-holder">
								<img class="pull-left" src="blogpost/images/graph-03.svg" width="90" alt="">
							</div>
							<div class="text-holder">
						...
						<li>
							<div class="img-holder">
								<img src="blogpost/images/graph-02.svg" height="84" alt="">
							</div>
							<div class="text-holder">
						...
						<li>
							<div class="img-holder">
								<img src="blogpost/images/graph-01.svg" height="71" alt="">
							</div>
							<div class="text-holder">
				...
				<div class="col-md-7">
					<div class="slide-holder">
						...
						<div class="img-slide scroll-trigger"><img src="blogpost/images/img-01.png" height="624" width="1184" alt=""></div>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="cycle-gallery">
						<div class="mask">
							<div class="slideset">
								<div class="slide">
									<div class="img-box">
										<div class="img-holder"><img src="blogpost/images/user-01.jpg" height="85" width="85" alt=""></div>
										<div class="text-holder">
								...
								<div class="slide">
									<div class="img-box">
										<div class="img-holder"><img src="blogpost/images/user-02.jpg" height="85" width="85" alt=""></div>
										<div class="text-holder">
								...
								<div class="slide">
									<div class="img-box">
										<div class="img-holder"><img src="blogpost/images/user-03.jpg" height="85" width="85" alt=""></div>
										<div class="text-holder">
		...
		<div class="visual-area">
			<div class="container">
				...
				<ul class="testimonials">
					<li>
						<div class="img-holder"><a href="#"><img src="blogpost/images/logo-smashing.png" height="43" width="165" alt="smashing magazine"></a></div>
					...
					<li>
						<div class="img-holder"><a href="#"><img src="blogpost/images/logo-codrops.png" height="50" width="148" alt="codrops"></a></div>
						<p><em>Donec euismod dolor ut ultricies consequat. Vivamus urna ipsum, rhoncus molestie neque ac, mollis eleifend nibh.</em></p>
					</li>
					<li>
						<div class="img-holder"><a href="#"><img src="blogpost/images/logo-w.png" height="64" width="64" alt="w"></a></div>
					...
					<li>
						<div class="img-holder"><a href="#"><img src="blogpost/images/logo-pixel.png" height="24" width="225" alt="Pixel Buddha"></a></div>
						<p><em>Sed vestibulum scelerisque urna, eu finibus leo facilisis sit amet. Proin id dignissim magna. Sed varius urna et pulvinar venenatis. </em></p>
					</li>
					<li>
						<div class="img-holder"><a href=""><img src="blogpost/images/logo-cb.png" height="34" width="166" alt="creative bloq"></a></div>
						<p><em>Praesent ut eros tristique, malesuada lectus vel, lobortis massa. Nulla faucibus lorem id arcu consequat faucibus. </em></p>
					</li>
					<li>
						<div class="img-holder"><a href="#"><img src="blogpost/images/logo-tnw.png" height="34" width="108" alt="tnw"></a></div>
			...
			<img src="blogpost/images/img-decor-02.jpg" height="764" width="1380" alt="" class="bg-stretch">
		</div>
		<div class="visual-area">
			<div class="container">
			...
			<img src="blogpost/images/img-decor-03.jpg" height="1175" width="1380" alt="" class="bg-stretch">
		</div>
	</section>
	<section class="area">
		<div class="container">
	...
	<footer id="footer">
		<div class="container">
			<div class="footer-holder">
				<div class="row">
					<div class="col-md-4">
						<div class="logo"><a href="#"><img src="images/logo.png" alt="Africa Gender Centre"></a></div>
...
<script src="blogpost/js/jquery-1.11.2.min.js"></script>
<script src="blogpost/js/bootstrap.js"></script>
<script src="blogpost/js/jquery.main.js"></script>
</body>
</html>